...
async def showcase_bracelets(cb: CallbackQuery):
    await safe_edit(cb, "💎 ВИТРИНА БРАСЛЕТОВ", parse_mode="Markdown", reply_markup=InlineKeyboardMarkup(inline_keyboard=[[InlineKeyboardButton(text="← НАЗАД", callback_data="menu")]]))
    await cb.answer()

@main_router.callback_query(F.data == "view_cart")
@rate_limit(2.0)
async def view_cart(cb: CallbackQuery):
    await safe_edit(cb, "🛒 КОРЗИНА", parse_mode="Markdown", reply_markup=InlineKeyboardMarkup(inline_keyboard=[[InlineKeyboardButton(text="← НАЗАД", callback_data="menu")]]))
    await cb.answer()

@main_router.callback_query(F.data == "my_orders")
@rate_limit(2.0)
async def my_orders(cb: CallbackQuery):
    await safe_edit(cb, "📋 МОИ ЗАКАЗЫ", parse_mode="Markdown", reply_markup=InlineKeyboardMarkup(inline_keyboard=[[InlineKeyboardButton(text="← НАЗАД", callback_data="menu")]]))
    await cb.answer()

@main_router.callback_query(F.data == "showcase_gifts")
@rate_limit(2.0)
async def showcase_gifts(cb: CallbackQuery):
    await safe_edit(cb, "🎁 ПОДАРКИ", parse_mode="Markdown", reply_markup=InlineKeyboardMarkup(inline_keyboard=[[InlineKeyboardButton(text="← НАЗАД", callback_data="menu")]]))
    await cb.answer()

@main_router.callback_query(F.data == "gift_menu")
@rate_limit(2.0)
async def gift_menu(cb: CallbackQuery):
    await safe_edit(cb, "🎁 МЕНЮ ПОДАРКОВ", parse_mode="Markdown", reply_markup=InlineKeyboardMarkup(inline_keyboard=[[InlineKeyboardButton(text="← НАЗАД", callback_data="menu")]]))
    await cb.answer()

@main_router.callback_query(F.data == "leave_review")
@rate_limit(2.0)
async def leave_review(cb: CallbackQuery):
    await safe_edit(cb, "⭐ ОСТАВИТЬ ОТЗЫВ", parse_mode="Markdown", reply_markup=InlineKeyboardMarkup(inline_keyboard=[[InlineKeyboardButton(text="← НАЗАД", callback_data="menu")]]))
    await cb.answer()

@main_router.callback_query(F.data == "faq")
@rate_limit(2.0)
async def faq(cb: CallbackQuery):
    await safe_edit(cb, "❓ FAQ", parse_mode="Markdown", reply_markup=InlineKeyboardMarkup(inline_keyboard=[[InlineKeyboardButton(text="← НАЗАД", callback_data="menu")]]))
    await cb.answer()

@main_router.callback_query(F.data == "knowledge_list")
@rate_limit(2.0)
async def knowledge_list(cb: CallbackQuery):
    await safe_edit(cb, "📚 БАЗА ЗНАНИЙ", parse_mode="Markdown", reply_markup=InlineKeyboardMarkup(inline_keyboard=[[InlineKeyboardButton(text="← НАЗАД", callback_data="menu")]]))
    await cb.answer()

@main_router.callback_query(F.data == "my_wishlist")
@rate_limit(2.0)
async def my_wishlist(cb: CallbackQuery):
    await safe_edit(cb, "❤️ ИЗБРАННОЕ", parse_mode="Markdown", reply_markup=InlineKeyboardMarkup(inline_keyboard=[[InlineKeyboardButton(text="← НАЗАД", callback_data="menu")]]))
    await cb.answer()

@main_router.callback_query(F.data == "my_referral")
@rate_limit(2.0)
async def my_referral(cb: CallbackQuery):
    await safe_edit(cb, "🎉 РЕФЕРАЛЬНАЯ ПРОГРАММА", parse_mode="Markdown", reply_markup=InlineKeyboardMarkup(inline_keyboard=[[InlineKeyboardButton(text="← НАЗАД", callback_data="menu")]]))
    await cb.answer()

@main_router.callback_query(F.data == "set_birthday")
@rate_limit(2.0)
async def set_birthday(cb: CallbackQuery):
    await safe_edit(cb, "🎂 ДЕНЬ РОЖДЕНИЯ", parse_mode="Markdown", reply_markup=InlineKeyboardMarkup(inline_keyboard=[[InlineKeyboardButton(text="← НАЗАД", callback_data="menu")]]))
    await cb.answer()

@main_router.callback_query(F.data == "my_stars_orders")
@rate_limit(2.0)
async def my_stars_orders(cb: CallbackQuery):
    await safe_edit(cb, "⭐ ЗАКАЗЫ ЗА ЗВЁЗДЫ", parse_mode="Markdown", reply_markup=InlineKeyboardMarkup(inline_keyboard=[[InlineKeyboardButton(text="← НАЗАД", callback_data="menu")]]))
    await cb.answer()

@main_router.callback_query(F.data == "totem_start")
@rate_limit(2.0)
async def totem_start(cb: CallbackQuery):
    await safe_edit(cb, "🔮 ТЕСТ TOTEM", parse_mode="Markdown", reply_markup=InlineKeyboardMarkup(inline_keyboard=[[InlineKeyboardButton(text="← НАЗАД", callback_data="menu")]]))
    await cb.answer()

@main_router.callback_query(F.data == "quiz_start")
@rate_limit(2.0)
async def quiz_start(cb: CallbackQuery):
    await safe_edit(cb, "❓ ВИКТОРИНА", parse_mode="Markdown", reply_markup=InlineKeyboardMarkup(inline_keyboard=[[InlineKeyboardButton(text="← НАЗАД", callback_data="menu")]]))
    await cb.answer()

@main_router.callback_query(F.data == "book_consult")
@rate_limit(2.0)
async def book_consult(cb: CallbackQuery):
    await safe_edit(cb, "👨‍🏫 КОНСУЛЬТАЦИЯ", parse_mode="Markdown", reply_markup=InlineKeyboardMarkup(inline_keyboard=[[InlineKeyboardButton(text="← НАЗАД", callback_data="menu")]]))
    await cb.answer()

@main_router.callback_query(F.data == "contact_master")
@rate_limit(2.0)
async def contact_master(cb: CallbackQuery):
    await safe_edit(cb, "📧 КОНТАКТЫ МАСТЕРА", parse_mode="Markdown", reply_markup=InlineKeyboardMarkup(inline_keyboard=[[InlineKeyboardButton(text="← НАЗАД", callback_data="menu")]]))
    await cb.answer()

@main_router.callback_query(F.data == "show_stories")
@rate_limit(2.0)
async def show_stories(cb: CallbackQuery):
    await safe_edit(cb, "📖 ИСТОРИИ КЛИЕНТОВ", parse_mode="Markdown", reply_markup=InlineKeyboardMarkup(inline_keyboard=[[InlineKeyboardButton(text="← НАЗАД", callback_data="menu")]]))
    await cb.answer()

@main_router.callback_query(F.data == "filter_bracelets")
@rate_limit(2.0)
async def filter_bracelets(cb: CallbackQuery):
    await safe_edit(cb, "🔍 ФИЛЬТР", parse_mode="Markdown", reply_markup=InlineKeyboardMarkup(inline_keyboard=[[InlineKeyboardButton(text="← НАЗАД", callback_data="menu")]]))
    await cb.answer()

@main_router.callback_query(F.data == "enter_promo")
@rate_limit(2.0)
async def enter_promo(cb: CallbackQuery):
    await safe_edit(cb, "🎟️ ПРОМОКОД", parse_mode="Markdown", reply_markup=InlineKeyboardMarkup(inline_keyboard=[[InlineKeyboardButton(text="← НАЗАД", callback_data="menu")]]))
    await cb.answer()

@main_router.callback_query(F.data == "subscribe_new")
@rate_limit(2.0)
async def subscribe_new(cb: CallbackQuery):
    await safe_edit(cb, "📬 ПОДПИСКА АКТИВИРОВАНА", parse_mode="Markdown", reply_markup=InlineKeyboardMarkup(inline_keyboard=[[InlineKeyboardButton(text="← НАЗАД", callback_data="menu")]]))
    await cb.answer()

@main_router.callback_query(F.data == "visit_site")
@rate_limit(2.0)
async def visit_site(cb: CallbackQuery):
    await safe_edit(cb, "🌐 САЙТ", parse_mode="Markdown", reply_markup=InlineKeyboardMarkup(inline_keyboard=[[InlineKeyboardButton(text="← НАЗАД", callback_data="menu")]]))
    await cb.answer()

@admin_router.callback_query(F.data == "admin_welcome_text")
@rate_limit(2.0)
async def admin_welcome_text(cb: CallbackQuery):
    if not is_admin(cb.from_user.id):
        await cb.answer("❌ НЕТ ПРАВ", show_alert=True)
        return
    await safe_edit(cb, "📝 ПРИВЕТСТВЕННЫЙ ТЕКСТ", parse_mode="Markdown", reply_markup=InlineKeyboardMarkup(inline_keyboard=[[InlineKeyboardButton(text="← НАЗАД", callback_data="admin_panel")]]))
    await cb.answer()
...
async def admin_categories(cb: CallbackQuery):
    if not is_admin(cb.from_user.id):
        await cb.answer("❌ НЕТ ПРАВ", show_alert=True)
        return
    await safe_edit(cb, "📂 КАТЕГОРИИ", parse_mode="Markdown", reply_markup=InlineKeyboardMarkup(inline_keyboard=[[InlineKeyboardButton(text="← НАЗАД", callback_data="admin_panel")]]))
    await cb.answer()

@admin_router.callback_query(F.data.in_(["admin_showcase", "admin_orders", "admin_cashback", "admin_gifts", "admin_faq", "admin_stories", "admin_knowledge", "admin_totem", "admin_quiz_results", "admin_push", "admin_broadcast", "admin_schedule", "admin_notify_new", "admin_promos", "admin_crm", "admin_seo", "admin_diagnostics", "admin_stats_v2", "admin_funnel", "admin_webview", "admin_website", "admin_smart_analytics"]))
@rate_limit(2.0)
async def admin_modules(cb: CallbackQuery):
    if not is_admin(cb.from_user.id):
        await cb.answer("❌ НЕТ ПРАВ", show_alert=True)
        return
    modules = {
        "admin_showcase": "💎 ВИТРИНА", "admin_orders": "📋 ЗАКАЗЫ", "admin_cashback": "💰 КЭШБЭК",
        "admin_gifts": "🎁 ПОДАРКИ", "admin_faq": "❓ FAQ", "admin_stories": "📖 ИСТОРИИ",
        "admin_knowledge": "📚 БАЗА", "admin_totem": "🔮 TOTEM", "admin_quiz_results": "❓ ВИКТОРИНА",
        "admin_push": "📢 PUSH", "admin_broadcast": "📣 РАССЫЛКА", "admin_schedule": "⏰ РАСПИСАНИЕ",
        "admin_notify_new": "🔔 УВЕДОМЛЕНИЯ", "admin_promos": "🎟️ ПРОМО", "admin_crm": "🔗 CRM",
        "admin_seo": "🔍 SEO", "admin_diagnostics": "🏥 ДИАГНОСТИКА", "admin_stats_v2": "📊 СТАТИСТИКА",
        "admin_funnel": "🔀 ВОРОНКА", "admin_webview": "🌐 WEBVIEW", "admin_website": "🌍 САЙТ",
        "admin_smart_analytics": "📈 АНАЛИТИКА"
    }
    title = modules.get(cb.data, "МОДУЛЬ")
    await safe_edit(cb, f"⚙️ {title}", parse_mode="Markdown", reply_markup=InlineKeyboardMarkup(inline_keyboard=[[InlineKeyboardButton(text="← НАЗАД", callback_data="admin_panel")]]))
    await cb.answer()
...
async def seo_descriptions(cb: CallbackQuery):
    if not is_admin(cb.from_user.id):
        await cb.answer("❌ НЕТ ПРАВ", show_alert=True)
        return
    await safe_edit(cb, "🔍 SEO ОПИСАНИЯ", parse_mode="Markdown", reply_markup=InlineKeyboardMarkup(inline_keyboard=[[InlineKeyboardButton(text="← НАЗАД", callback_data="admin_seo")]]))
    await cb.answer()
...
async def seo_posts(cb: CallbackQuery):
    if not is_admin(cb.from_user.id):
        await cb.answer("❌ НЕТ ПРАВ", show_alert=True)
        return
    await safe_edit(cb, "📝 SEO ПОСТЫ", parse_mode="Markdown", reply_markup=InlineKeyboardMarkup(inline_keyboard=[[InlineKeyboardButton(text="← НАЗАД", callback_data="admin_seo")]]))
    await cb.answer()
...
async def seo_reels(cb: CallbackQuery):
    if not is_admin(cb.from_user.id):
        await cb.answer("❌ НЕТ ПРАВ", show_alert=True)
        return
    await safe_edit(cb, "🎬 SEO ВИДЕО", parse_mode="Markdown", reply_markup=InlineKeyboardMarkup(inline_keyboard=[[InlineKeyboardButton(text="← НАЗАД", callback_data="admin_seo")]]))
    await cb.answer()
...
async def crm_test(cb: CallbackQuery):
    if not is_admin(cb.from_user.id):
        await cb.answer("❌ НЕТ ПРАВ", show_alert=True)
        return
    await safe_edit(cb, "🧪 ТЕСТ CRM", parse_mode="Markdown", reply_markup=InlineKeyboardMarkup(inline_keyboard=[[InlineKeyboardButton(text="← НАЗАД", callback_data="admin_crm")]]))
    await cb.answer()
...
async def crm_test_order(cb: CallbackQuery):
    if not is_admin(cb.from_user.id):
        await cb.answer("❌ НЕТ ПРАВ", show_alert=True)
        return
    await safe_edit(cb, "📝 ТЕСТОВЫЙ ЗАКАЗ", parse_mode="Markdown", reply_markup=InlineKeyboardMarkup(inline_keyboard=[[InlineKeyboardButton(text="← НАЗАД", callback_data="admin_crm")]]))
    await cb.answer()
...
async def analytics_forecast(cb: CallbackQuery):
    if not is_admin(cb.from_user.id):
        await cb.answer("❌ НЕТ ПРАВ", show_alert=True)
        return
    await safe_edit(cb, "📈 ПРОГНОЗ ПРОДАЖ", parse_mode="Markdown", reply_markup=InlineKeyboardMarkup(inline_keyboard=[[InlineKeyboardButton(text="← НАЗАД", callback_data="admin_smart_analytics")]]))
    await cb.answer()
...
async def analytics_seasons(cb: CallbackQuery):
    if not is_admin(cb.from_user.id):
        await cb.answer("❌ НЕТ ПРАВ", show_alert=True)
        return
    await safe_edit(cb, "📊 СЕЗОННОСТЬ", parse_mode="Markdown", reply_markup=InlineKeyboardMarkup(inline_keyboard=[[InlineKeyboardButton(text="← НАЗАД", callback_data="admin_smart_analytics")]]))
    await cb.answer()
...
async def analytics_sleeping(cb: CallbackQuery):
    if not is_admin(cb.from_user.id):
        await cb.answer("❌ НЕТ ПРАВ", show_alert=True)
        return
    await safe_edit(cb, "😴 СПЯЩИЕ ПОКУПАТЕЛИ", parse_mode="Markdown", reply_markup=InlineKeyboardMarkup(inline_keyboard=[[InlineKeyboardButton(text="← НАЗАД", callback_data="admin_smart_analytics")]]))
    await cb.answer()
...
async def export_orders(cb: CallbackQuery):
    if not is_admin(cb.from_user.id):
        await cb.answer("❌ НЕТ ПРАВ", show_alert=True)
        return
    await safe_edit(cb, "📥 ЭКСПОРТ ЗАКАЗОВ", parse_mode="Markdown", reply_markup=InlineKeyboardMarkup(inline_keyboard=[[InlineKeyboardButton(text="← НАЗАД", callback_data="admin_orders")]]))
    await cb.answer()

@main_router.callback_query(F.data == "webview_generate")
@rate_limit(2.0)
async def webview_generate(cb: CallbackQuery):
    await safe_edit(cb, "🌐 WEBVIEW ГЕНЕРАЦИЯ", parse_mode="Markdown", reply_markup=InlineKeyboardMarkup(inline_keyboard=[[InlineKeyboardButton(text="← НАЗАД", callback_data="menu")]]))
    await cb.answer()
...
@rate_limit(2.0)
async def website_generate(cb: CallbackQuery):
    await safe_edit(cb, "🌍 САЙТ ГЕНЕРАЦИЯ", parse_mode="Markdown", reply_markup=InlineKeyboardMarkup(inline_keyboard=[[InlineKeyboardButton(text="← НАЗАД", callback_data="menu")]]))
    await cb.answer()
...
async def noop(cb: CallbackQuery):
    await cb.answer("🚀 СКОРО!", show_alert=False)

@main_router.callback_query()
async def fallback(cb: CallbackQuery):
    await cb.answer("ℹ️ НЕ РЕАЛИЗОВАНО", show_alert=False)
